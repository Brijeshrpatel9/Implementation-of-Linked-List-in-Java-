...
public class LinkedListNodeIterator<AnyType> implements Iterable<AnyType>
{
 ...
 /**
   ...
   *  Complexity: O(n^2)
   */
   public  LinkedListNodeIterator<AnyType> copy1()
   {
      LinkedListNodeIterator<AnyType> twin = new LinkedListNodeIterator<AnyType>();
      Node<AnyType> tmp = head;
      while(tmp != null)
      {
 ...
 /**
   ...
   *  Complexity: O(n)
   */
   public LinkedListNodeIterator<AnyType> copy2()
   {
      LinkedListNodeIterator<AnyType> twin = new LinkedListNodeIterator<AnyType>();
      Node<AnyType> tmp = head;
      while(tmp != null)
 ...
 /**
   ...
   *  Complewxity: O(n)
   */
   public LinkedListNodeIterator<AnyType> reverse()
   {
      LinkedListNodeIterator<AnyType> list = new LinkedListNodeIterator<AnyType>();
      Node<AnyType> tmp = head;
      while(tmp != null)
      {
 ...
 /**
   ...
   *  Complexity: O(n)
   */
   public LinkedListNodeIterator<AnyType> copy3()
   {
      LinkedListNodeIterator<AnyType> twin = new LinkedListNodeIterator<AnyType>();
      Node<AnyType> tmp = head;
